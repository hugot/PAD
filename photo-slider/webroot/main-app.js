...
/**
 * Beweeg de audio sectie zodat deze zichtbaar/onzichtbaar wordt.
 */
...
/**
 * Toon de lijst met selecteerbare foto's die gestuurd wordt als response op
 * een reqquest naar de gegeven url.
 * @param {*} url 
 */
...
/**
 * Selecteer media in een daarvoor bestemde lijst.
 * @param {*} divId 
 * @param {*} mediaId 
 */
...
/**
 * Geef geselecteerde media de juiste kleur.
 * @param {*} div 
 */
...
/**
 * Toon een popup waarmee de geselecteerde media verwijderd kan
 * worden.
 */
...
/**
 * Voeg media toe aan een thema.
 */
function addMediaToTheme() {
    sendSelectedMediaTo('/addmediatotheme');
}

/**
 * Verwijder media permanent.
 */
...
/**
 * Toon de popup met de gegeven id.
 * @param {*} popupId 
 */
...
/**
 * Verstop de popup met de gegeven id.
 * @param {*} popupId 
 */
...
/**
 * Verwijder popup met de gegeven id uit de getoonde webpagina.
 * @param {*} popupId 
 */
...
/**
 * Toon een lijst met selecteerbare thema's.
 */
...
/**
 * Stuur de geselecteerde thema's in een HTTPRequest naar de gegeven url.
 * @param {*} url 
 */
...
/**
 * Reset de data van de applicatie naar de nieuwstaat.
 */
...
/**
 * Voeg een bepaalde tekst toe aan de inhoud van de popupwrapper.
 * @param {*} responseText 
 */
